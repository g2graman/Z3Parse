...
class Z3proofFormatter(ParseTreeListener):

    # Enter a parse tree produced by Z3proofParser#proof.
    def enterProof(self, ctx):
        pass

    # Exit a parse tree produced by Z3proofParser#proof.
    ...
    # Exit a parse tree produced by Z3proofParser#proof_rule.
    ...
    # Exit a parse tree produced by Z3proofParser#expression.
    ...
    # Exit a parse tree produced by Z3proofParser#argumentList.
